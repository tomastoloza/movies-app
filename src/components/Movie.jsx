...
const Movie = ({movie}) => {
    ...
    return (
        <div
            className={"w-1/6 flex flex-col justify-between m-8 shadow-lg rounded-lg bg-gray-200"}>
            ...
            <button
                className={"bg-yellow-400 hover:bg-yellow-500 w-full h-10 rounded-b-lg w-full focus:ring-2 focus:ring-red-500 focus-inset"}
                onClick={() => {
                    setToggle(!toggle)
